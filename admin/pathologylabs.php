...
<?php
  ...
  <div class="col s12 m6">
    ...
    <div class="card-content">
      <span class="card-title activator grey-text text-darken-4"><?php echo $row['pathologyname']?><i class="material-icons right">more_vert</i></span>
...
<?php 
  ...
  ?>
    ...
    <a class="btn-floating btn-large red tooltipped" data-position="left" data-delay="50" data-tooltip="Add labs" href="addpathologylab.php">
